...
def load_store():
    ...
    print(f"Built {len(chunks)} chunks from {len(docs)} transcripts, now embedding and storing in {DB_DIR} ...")
...
if __name__ == "__main__":
    ...
    results = retriever.invoke("How will you evaluate a rag application?")
